...
const postUserRsvp = async (req, res) => {
  try {
    ...
    req.setHeader('Access-Control-Allow-Methods', 'POST, OPTIONS, PUT');
    req.setHeader('Access-Control-Allow-Headers', 'Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With');
